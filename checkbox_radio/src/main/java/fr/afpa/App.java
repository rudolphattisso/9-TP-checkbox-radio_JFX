...
public class App extends Application {
    ...
    public void start(Stage stage) {
        ...
        colorBack.selectedProperty().addListener((observable, oldValue, newValue) -> {// lors de clique checkbox,la section Backround s'affiche
        ...
        colorChar.selectedProperty().addListener((observable, oldValue, newValue) -> {// lors de clique checkbox,la section Backround s'affiche
        ...
        majMinChar.selectedProperty().addListener((observable, oldValue, newValue) -> {// lors de clique checkbox,la section Backround s'affiche
